...
Hello, I would like to explain my Excel project. This project is based on Blinkit grocery sales data. The main aim was to convert raw data into a simple interactive dashboard so that business performance can be understood quickly. In this project, I used Excel tools like data cleaning, formulas, pivot tables, pivot charts, KPI cards, and filters
# Blinkit Excel Dashboard

## Project Overview
This project is an interactive Excel dashboard created using Blinkit grocery sales data. The main purpose of this project is to convert raw sales data into meaningful insights with the help of Excel tools and visualizations. The dashboard helps in understanding sales performance, customer preferences, outlet performance, and business trends in a simple and clear way.

## Objective
The objective of this project is to analyze Blinkit grocery data and build an interactive dashboard that can help users:
